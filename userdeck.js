var UserDeck = {
    ...
    showConnect : function (type, start) {
        ...
        var iframe = jQuery('<iframe id="iframe-connect" src="https://app.userdeck.com/' + type + '?redir=' + start + '" width="400" height="600" frameborder="0" ALLOWTRANSPARENCY="true"></iframe>');
